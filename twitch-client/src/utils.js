...
const SERVER_ORIGIN = "";
//这里的origin 还是3000, 然后会通过package.json => redirect 给8080
const loginUrl = `${SERVER_ORIGIN}/login`;

export const login = credential => {
  //fetch 是window下面的global API
  //fetch 返回回来的object 就叫Promise
  //Promise object 会有一个方法叫.then()
  return fetch(loginUrl, {
    ...
    //cookie里放什么东西 是谁定义的呢 :
    //Backend: HttpSession session = request.getSession();
